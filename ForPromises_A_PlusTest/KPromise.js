const {identity, isFn, warn, isObj} = require('./utils.js');
 ...
 */
KPromise.resolvePromise = function(newPromise, res, resolve, reject){
 ...
 * @returns {KPromise}
 */
KPromise.prototype.then = function (resolveHandle, rejectHandle) {
 ...
 * @returns {KPromise}
 */
KPromise.all = function(promises){
 ...
 * @returns {KPromise}
 */
KPromise.prototype.catch = function(handle){
 ...
 * @returns {KPromise}
 */
KPromise.race = function(promises){
